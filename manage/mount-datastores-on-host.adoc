...
NOTE: Ao adicionar um novo host ESXi usando o  https://techdocs.broadcom.com/["Documentação técnica Broadcom"^], aguarde a conclusão da descoberta agendada do host antes que ele apareça nas ONTAP tools. Como alternativa, você pode executar a descoberta manualmente na tela de visão geral do NetApp ONTAP tools.
