...
Para obter mais informações sobre como usar NVMe/FC com VMware vSphere 7.0, consulte  https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html["Guia de configuração do host ONTAP NVMe/FC"] e  https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684"].
