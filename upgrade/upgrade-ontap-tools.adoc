...
* Vá até a aba de snapshots e selecione o botão *Take Snapshot*. Tire um snapshot quiescido da VM. Consulte  https://techdocs.broadcom.com/["Documentação técnica Broadcom"^] para obter detalhes.
